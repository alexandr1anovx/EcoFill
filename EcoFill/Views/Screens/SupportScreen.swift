        ...
        NavigationStack {
            VStack(alignment: .leading, spacing: 10) {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    BaseButton(image: .success,title: "Send feedback",pouring: .cmBlue) {
            ...
            // set email address to text field
            .onAppear { setUserEmail() }
        }
    }
}

extension SupportScreen {
    private var isCorrectMessage: Bool { message.count > 9 }
